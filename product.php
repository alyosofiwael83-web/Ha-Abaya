...
// Static Product Data
$product_id = $_GET['id'] ?? 101;
// Mock Data
$product = [
    'id' => $product_id,
    'name' => 'عباية سوداء تطريز ذهبي فاخر',
    'category_id' => 1,
    'category_name' => 'عبايات مناسبات',
    'price' => 350.00,
    'old_price' => 450.00,
    'description' => "عباية سوداء ملكية تتميز بتطريز ذهبي دقيق على الأكمام والأطراف، مصنوعة من قماش الكريب السعودي الفاخر الذي يمنحك انسيابية وراحة في الارتداء.\n\nالمميزات:\n- قماش كريب فاخر\n- تطريز يدوي ذهبي\n- قصة واسعة مريحة\n- مناسبة للمناسبات الرسمية والخاصة",
    'available_colors' => 'أسود',
    'size' => '52, 54, 56, 58, 60',
    'stock_quantity' => 10,
...
$gallery_images = [
    'assets/images/products/abaya_emb_main.jpg',
    'assets/images/products/abaya_emb_detail1.jpg',
    'assets/images/products/abaya_emb_detail2.jpg'
];
