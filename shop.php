...
$products = [
    ...
    [
        ...
        'price' => 45,
        'old_price' => 60,
        'main_image' => 'assets/images/categories/6957ef073ac5e.jpeg' // Using category image as product
    ]
];

$categories = [
    ['id' => 1, 'name' => 'عبايات يومية'], 
    ['id' => 2, 'name' => 'عبايات مناسبات'],
    ['id' => 3, 'name' => 'عبايات شتوية'],
    ['id' => 4, 'name' => 'طرح ونقابات'],
    ['id' => 5, 'name' => 'اكسسوارات']
];

// Mock sorting or filtering variables to prevent undefined errors
