...
<div class="acc-wrapper">
    ...
    <div class="acc-menu">
        ...
        <a href="wallet.php" class="acc-menu-item">
            <div class="acc-arrow"><i class="fas fa-chevron-left"></i></div>
            <div class="acc-label">المحفظة</div>
            <div class="acc-icon"><i class="fas fa-wallet"></i></div>
        </a>

        <a href="page.php?name=refund" class="acc-menu-item">
            <div class="acc-arrow"><i class="fas fa-chevron-left"></i></div>
            <div class="acc-label">سياسة الاسترجاع</div>
            <div class="acc-icon"><i class="fas fa-undo"></i></div>
        </a>

        <a href="page.php?name=privacy" class="acc-menu-item">
            <div class="acc-arrow"><i class="fas fa-chevron-left"></i></div>
            <div class="acc-label">سياسة الخصوصية</div>
            <div class="acc-icon"><i class="fas fa-shield-alt"></i></div>
        </a>

        <a href="page.php?name=about" class="acc-menu-item">
            <div class="acc-arrow"><i class="fas fa-chevron-left"></i></div>
            <div class="acc-label">من نحن</div>
    ...
    <div class="acc-copyright">
        <p>جميع الحقوق محفوظة &copy; زهراء 2026</p>
